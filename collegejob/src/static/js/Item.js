...
class Item extends React.Component {
    ...
    render() {
        ...
        return (
            <div className={
                `item-card  ${moreCount > 0 ? "" : "--allow-hover"}`
            } >
                <img src={
                    imgArray[index % imgArray.length]
                }
                ...
                <div className="item-card-content" > {
                    ...
                    <div className="item-card__tags" > {
                        data.food_types.slice(0, 3).map((type) => {
                            return <div className="item-card__tag" > {
                                type
                            }
                            </div>;
                        })
                    ...
                    <div className="item-card__stats-row" >
                        <div className={
                            `item-card__star-wrap ${data.ratings ? "--green" : ""
                            }`
                        } >
                            {
                                data.ratings || " --"
                            }
                        </div> <div > • </div> <div className="item-card__delivery-time" > {
                            data.delivery_time
                        } </div> <div > • </div>
                    ...
                    <div className="item-card__quick-view" >
                        QUICK VIEW
                    </div>
                </div>
                {
                    moreCount > 0 && (<div className="item-card__more-wrap"
                        onClick={
